...
export default function Home() {
  return (
    <div className="h-screen w-[70%] mx-auto p-6">
      <div className="p-12 mt-20 shadow-lg rounded-lg bg-slate-100 text-center flex flex-col justify-center items-center gap-6">
        ...
        <ul className="flex gap-4 justify-center items-center mt-4">
          <li>
